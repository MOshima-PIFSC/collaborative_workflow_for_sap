...
{{< fa quote-left >}} Open Science is the principle and practice of making research products and processes available to all, while respecting diverse cultures, maintaining security and privacy, and fostering collaborations, reproducibility, and equity.
...
-   Open science community
    ...
    {{< fa brands github size=5x >}} {{< fa brands google-drive size=5x >}}

## Benefits of automated workflows {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}
...
## Challenges of American Samoa Bottomfish Assessment {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}
...
::: {.column .incremental width="50%"}
-   Set up 2 Google Sheets ([inputs](https://docs.google.com/spreadsheets/d/11lPJV7Ub9eoGbYjoPNRpcpeWUM5RYl4W65rHHFcQ9fQ/edit#gid=404015578) and [parameters](https://docs.google.com/spreadsheets/d/1XvzGtPls8hnHHGk7nmVwhggom4Y1Zp-gOHNw4ncUs8E/edit#gid=195137582)) that we could change and pull the information directly into R with real-time updated information.
:::
:::
...
## Our Workflow {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}

<br>

![](imgs/process_diagram.PNG){fig-align="center" width="15in"}

## Repository Structure {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}

![](imgs/github_repo_1.png)

## Repository Structure {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}

![](imgs/github_repo_2.png)

## Repository Structure {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}

![](imgs/github_repo_3.png)

## Repository Structure {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}

![](imgs/github_repo_4.png)
...
## Step 06: Generate formatted tables and figures {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}
...
## Discussion points {background-color="#ffffff" background-image="imgs/sidebar_midnights.png" background-size="contain" background-repeat="no-repeat" background-position="left"}
